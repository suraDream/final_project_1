...
console.log("fieldId from useParams:", fieldId);  // เช็คค่าของ fieldId
const fieldIdNumber = Number(fieldId);

if (isNaN(fieldIdNumber)) {
  console.error("❌ ID ของสนามหลักไม่ถูกต้อง:", fieldId);
  alert("❌ ID ของสนามหลักไม่ถูกต้อง");
  return;
}

console.log("Main Field ID:", fieldIdNumber);
