...
<div className="field-details">
  ...
  {editingField === "first_name" ? (
    ...
    <>
      ...
      <button onClick={() => startEditing("first_name", field.first_name)}>✏️ แก้ไข</button>
    </>
  )}
  ...
  {editingField === "field_description" ? (
    ...
    <>
      ...
      <button onClick={() => startEditing("first_name", field.field_description)}>✏️ แก้ไข</button>
    </>
  )}
  <br /><label>📍นามสกุล:</label>
  {editingField === "last_name" ? (
    ...
    <>
      ...
      <button onClick={() => startEditing("last_name", field.last_name)}>✏️ แก้ไข</button>
    </>
  )}
...
<br /><label>📍email</label>
  {editingField === "email" ? (
    ...
    <>
      ...
      <button onClick={() => startEditing("email", field.email)}>✏️ แก้ไข</button>
    </>
  )}

<br /><label>📍 ชื่อสนาม:</label>
...
<br /><label>📍พิกัด</label>
  {editingField === "gps_location" ? (
    ...
    {field?.gps_location|| "❌ ไม่มีข้อมูล"}
      ...
      <button onClick={() => startEditing("gps_location", field.gps_location)}>✏️ แก้ไข</button>
    </>
  )}
  

  <br /><label>📍เวลาทำเปิด:</label>
  {editingField === "open_hours" ? (
    ...
    <>
      ...
      <button onClick={() => startEditing("open_hours", field.open_hours)}>✏️ แก้ไข</button>
    </>
  )}

  <br /><label>📍เวลาทำปิด:</label>
  {editingField === "close_hours" ? (
    ...
    <>
      ...
      <button onClick={() => startEditing("close_hours", field.close_hours)}>✏️ แก้ไข</button>
    </>
  )}

<br /><label>📍 ค่ามัดจำ:</label>
{editingField === "price_deposit" ? (
  <>
    ...
    />
    <button onClick={() => saveField("price_deposit")}>💾 บันทึก</button>
    <button onClick={cancelEditing}>ยกเลิก</button>
  </>
) : (
  <>
    ...
    <button onClick={() => startEditing("price_deposit", field.price_deposit)}>✏️ แก้ไข</button>
  </>
)}



<br /><label>🏦 ธนาคาร:</label>
  {editingField === "name_bank" ? (
    ...
    <>
      ...
      <button onClick={() => startEditing("name_bank", field.name_bank)}>✏️ แก้ไข</button>
    </>
  )}
...
{previewUrl && <img src={previewUrl} alt="preview" />}
  ...
  <>
    ...
    <button onClick={() => startEditing("img_field", field.img_field)}>✏️ แก้ไข</button>
  </>
)}

<br /><label>เอกสาร:</label>
{editingField === "documents" ? (
 ...
 <input type="file" onChange={handleChange} />
  ...
  <>
    ...
    <button onClick={() => startEditing("documents", field.documents)}>✏️ แก้ไข</button>
  </>
)}
...
{subFields.map((sub, index) => (
  ...
  <>
    <p><strong>ชื่อสนามย่อย:</strong> {sub.sub_field_name}</p>
    <p><strong>ราคา:</strong> {sub.price} บาท</p>
    <button onClick={() => startEditing("sub_fields", sub.sub_field_name)}>✏️ แก้ไข</button>
  </>
)}
  ...
  <button onClick={() => router.push("/")} className="back-btn">🔙 กลับไปหน้าหลัก</button>
</div>
