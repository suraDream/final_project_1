        ...
        <div className="field-details">
          <div className="input-group">
            ...
            {editingField === "field_name" ? (
              <>
                ...
                />
                <button onClick={() => saveField("field_name")}>
                  บันทึก
                </button>
            ...
            {editingField === "gps_location" ? (
              <>
                <input
                  ...
                  onChange={(e) => setUpdatedValue(e.target.value)}
                />
                <button onClick={() => saveField("gps_location")}>
                  💾 บันทึก
                </button>
                <button onClick={cancelEditing}>ยกเลิก</button>
              </>
            ...
            {editingField === "open_hours" ? (
              <>
                <input
                  ...
                  onChange={(e) => setUpdatedValue(e.target.value)}
                />
                <button onClick={() => saveField("open_hours")}>
                  💾 บันทึก
                </button>
                <button onClick={cancelEditing}>ยกเลิก</button>
              </>
            ...
            {editingField === "close_hours" ? (
              <>
                <input
                  ...
                  onChange={(e) => setUpdatedValue(e.target.value)}
                />
                <button onClick={() => saveField("close_hours")}>
                  💾 บันทึก
                </button>
                <button onClick={cancelEditing}>ยกเลิก</button>
              </>
            ...
            {editingField === "name_bank" ? (
              <>
                <input
                  ...
                  onChange={(e) => setUpdatedValue(e.target.value)}
                />
                <button onClick={() => saveField("name_bank")}>
                  💾 บันทึก
                </button>
                <button onClick={cancelEditing}>ยกเลิก</button>
              </>
            ...
            {editingField === "account_holder" ? (
              <>
                <input
                  ...
                  onChange={(e) => setUpdatedValue(e.target.value)}
                />
                <button onClick={() => saveField("account_holder")}>
                  💾 บันทึก
                </button>
                <button onClick={cancelEditing}>ยกเลิก</button>
              </>
              ...
              <>
                ...
                <button
                  onClick={() => startEditing("account_holder", field?.account_holder)}
                >
                  ✏️ แก้ไข
                </button>
              </>
            ...
            {editingField === "number_bank" ? (
              <>
                <input
                  ...
                  onChange={(e) => setUpdatedValue(e.target.value)}
                />
                <button onClick={() => saveField("number_bank")}>
                  💾 บันทึก
                </button>
                <button onClick={cancelEditing}>ยกเลิก</button>
              </>
              ...
              <>
                ...
                <button
                  onClick={() => startEditing("account_holder", field?.number_bank)}
                >
                  ✏️ แก้ไข
                </button>
              </>
          ...
          <div className="input-group">
            ...
            {editingField === "img_field" ? (
              <div className="preview-container">
                ...
                <button onClick={() => saveField("img_field")}>
                  💾 บันทึก
                </button>
                <button onClick={cancelEditing}>ยกเลิก</button>
              </div>
          ...
          <div className="input-group">
            ...
            {editingField === "documents" ? (
              <>
                <input type="file" onChange={handleChange} />
                <button onClick={() => saveField("documents")}>
                  💾 บันทึก
                </button>
                <button onClick={cancelEditing}>ยกเลิก</button>
              </>
