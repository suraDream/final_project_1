...
export default function CheckFieldDetail() {
  ...
  const deleteSubField = async (sub_field_id) => {
    ...
    try {
      const response = await fetch(`${API_URL}/field/delete/subfield/${sub_field_id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const deleteAddOn = async (add_on_id) => {
    ...
    try {
      const response = await fetch(`${API_URL}/field/delete/addon/${add_on_id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  <div key={subField.sub_field_id}>
    ...
    <button onClick={() => handleDeleteClick(subField)}>Delete</button>
  </div>
))}
            </>
          )}
