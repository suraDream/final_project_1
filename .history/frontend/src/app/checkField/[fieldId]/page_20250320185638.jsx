...
export default function CheckFieldDetail() {
  ...
  const handleStatusChange = (fieldId, newStatus) => {
    const confirmation = window.confirm(
      `คุณแน่ใจว่าจะยืนยันสิทธิ์และเปลี่ยนสถานะเป็น: ${newStatus}?`
    );
      ...
      <div className="field-detail-container">
        ...
        <div className="field-info">
          <div className="upinfo">
            ...
            <p>
  <strong>สถานะ:</strong> 
  <span className={fieldData?.status === "ผ่านการอนุมัติ" ? "status-approved" : "status-rejected"}>
    {fieldData?.status}
  </span>
</p>
          </div>
        ...
        <div className="status-buttons">
          <button
            ...
            onClick={() => handleStatusChange(fieldId, "ผ่านการอนุมัติ")}
          >
            ผ่านการอนุมัติ
          </button>
          <button
            className="reject-btn"
            onClick={() => handleStatusChange(fieldId, "ไม่ผ่านการอนุมัติ")}
          >
            ไม่ผ่านการอนุมัติ
          </button>
        </div>
