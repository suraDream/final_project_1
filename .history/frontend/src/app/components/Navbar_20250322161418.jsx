...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/field/sports-categories`, {
      method: "GET",
      headers: {
      ...
      .then((res) => {
        if (!res.ok) {
          return res.json().then((errorData) => {
            console.error("Error response:", errorData); // Log the error message in JSON format
            throw new Error(errorData.error || "Failed to fetch sports categories"); // Use the error message from the response
          });
        }
