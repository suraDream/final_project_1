...
export default function Navbar({ user }) {
  ...
  useEffect(() => {
    ...
    console.log("Token from localStorage:", storedToken); // ตรวจสอบค่าที่ได้
          ...
          >
            ...
            <div className="dropdown">
              <ul>
                ...
                {user?.role === "customer" && <li><a href="/#">ดูรายละเอียดการจอง</a></li>}
                {user?.role === "owner" && <li><a href="/#">ลงทะเบียนสนาม</a></li>}
                {user?.role === "admin" && <li><a href="/#">จัดการผู้ใช้</a></li>}
                <li><LogoutButton /></li>
              </ul>
            </div>
          </div>
