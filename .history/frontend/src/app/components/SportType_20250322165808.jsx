              ...
              <div className="grid">
                {sport.fields.length > 0 ? (
                  sport.fields.map((field) => {
                    // สร้าง key โดยใช้ field_id และ sub_field_id ถ้า sub_field_id ไม่มีค่า ใช้ field_id แทน
                    const key = field.sub_field_id ? `${field.field_id}-${field.sub_field_id}` : `${field.field_id}`;
                    return (
                      <div
