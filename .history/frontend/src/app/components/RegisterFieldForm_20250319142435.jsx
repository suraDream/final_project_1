          ...
          <div key={fac.fac_id} className="facility-item">
            ...
            {selectedFacilities[fac.fac_id] !== undefined && (
             ...
             <input
               ...
               onChange={(e) => {
                 // ตรวจสอบและแปลงค่าที่กรอกให้เป็นค่าบวก
                 let value = parseFloat(e.target.value);
                 // ป้องกันค่าติดลบหรือกรอกเป็นข้อความที่ไม่ใช่ตัวเลข
                 if (value < 0 || isNaN(value)) {
                   value = 0; // ถ้าค่าที่กรอกติดลบหรือไม่ใช่ตัวเลข ให้เป็น 0
                 }
                 handleFacilityPriceChange(fac.fac_id, value); // ส่งค่าใหม่ที่เป็นค่าบวกหรือ 0
               }}
             />
           </div>
