    ...
    <nav>
      ...
      <div className="ullist">
        <ul className={isMenuOpen ? "active" : ""}>
          ...
          <li>
  <a
    href="/categories#booking-section"
    onClick={(e) => {
      e.preventDefault(); // ป้องกันการเปลี่ยนหน้า
      router.push("/categories#booking-section"); // ใช้ Next.js Router เพื่อเปลี่ยนหน้า
      setTimeout(scrollToBookingSection, 500); // เลื่อนหลังจากเปลี่ยนหน้า
    }}
  >
    ไปที่การจอง
  </a>
