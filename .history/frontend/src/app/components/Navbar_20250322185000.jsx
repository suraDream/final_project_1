...
export default function Navbar() {
  ...
  const handleNavigation = (e) => {
    e.preventDefault();
    router.push("/categories#booking-section"); // เปลี่ยนหน้าไปยัง /categories และเลื่อนไปยัง #booking-section
    setTimeout(scrollToBookingSection, 500); // รอให้หน้าถูกโหลดก่อน แล้วจึงเลื่อน
  };
    ...
    <nav>
      ...
      <div className="ullist">
        <ul className={isMenuOpen ? "active" : ""}>
          ...
          <li>
             <a href="/categories#booking-section" onClick={handleNavigation}>ไปที่การจอง</a>
          </li>
          <li>
