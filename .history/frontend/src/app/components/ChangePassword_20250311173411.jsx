...
export default function ChangePassword() {
  ...
  const handlePasswordChange = async (e) => {
    ...
    // ตรวจสอบว่า `first_name` และ `last_name` ไม่เป็น null
    ...
    try {
      ...
      if (data.success) {
        ...
        const updateResponse = await fetch(`${API_URL}/users/${user.user_id}`, {
          ...
          body: JSON.stringify({ password: newPassword, first_name: user.first_name, last_name: user.last_name, email: user.email, role: user.role }),
        });
