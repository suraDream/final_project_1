  ...
  useEffect(() => {
    const fetchMyFields = async () => {
      try {
        ...
        const sportId = selectedSportId; // ค่าจากการเลือกประเภทกีฬาใน UI
  
        const url = sportId 
          ? `${API_URL}/field/myfields?sport_id=${sportId}`
          : `${API_URL}/field/myfields`;  // ถ้าไม่มี sportId, ส่งคำขอแค่สนามทั้งหมด
    ...
    fetchMyFields();
  }, [selectedSportId]);  // กรองตาม sport_id ทุกครั้งที่เปลี่ยน
