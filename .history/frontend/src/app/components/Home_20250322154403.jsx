...
export default function HomePage() {
  ...
  <div key={field.field_id} className="card" onClick={() => router.push(`/field/${field.field_id}`)}>
    <img
      src={field.img_field || "https://via.placeholder.com/300x200"}
    ...
    <div className="card-body">
      ...
      <p>เปิดเวลา: {field.open_hours} น.- {field.close_hours} น.</p>
      <p>วันทำการ: {convertToThaiDays(field.open_days)}</p>
    </div>
  </div>
))}
          </div>
