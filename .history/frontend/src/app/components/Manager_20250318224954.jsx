...
export default function AdminManager() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/field/allow`)
      ...
      .catch((error) =>
        console.error("❌ Error fetching allow fields:", error)
      );
  }, []);
  ...
  useEffect(() => {
    fetch(`${API_URL}/field/refuse`)
      ...
      .catch((error) =>
        console.error("❌ Error fetching refuse fields:", error)
      );
  }, []);
                ...
                <tr key={field.field_id}>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => handleViewDetails(field.field_id)}
                    >
                      ดูรายละเอียดสนาม
                    </button>
                    <button
        ...
        <table>
          ...
          <tbody>
            {refuseFields.length > 0 ? (
              ...
              <tr>
                <td colSpan="4" style={{ textAlign: "center" }}>
                  ไม่มีสนามกีฬาที่ผ่านการอนุมัติสอบ
                </td>
              </tr>
            )}
          </tbody>
