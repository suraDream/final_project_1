...
router.delete("/field/subfield/:id", async (req, res) => {
  ...
  try {
    ...
    await pool.query("DELETE FROM subfields WHERE sub_field_id = $1", [subFieldId]);
